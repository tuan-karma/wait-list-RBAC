defmodule WaitListWeb.RuleControllerTest do
  use WaitListWeb.ConnCase

  alias WaitList.Authorization

  @create_attrs %{permissions: [], resource: "some resource", role: "some role"}
  ...
  def fixture(:rule) do
    {:ok, rule} = Authorization.create_rule(@create_attrs)
    rule
  end
